...
The `meta-rdk-broadband-apps` layer provides support for various TR-369 data models to enable remote management and monitoring of containerized applications and device capabilities.
